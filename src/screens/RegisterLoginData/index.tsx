...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: SubmitHandler<FormData>) {
    const newLoginData = {
      id: String(uuid.v4()),
      ...formData,
    };
    ...
    const dataSaved = await AsyncStorage.getItem(dataKey);
    const oldData = JSON.parse(dataSaved ?? "[]");
    const updatedData = [...oldData, newLoginData];
